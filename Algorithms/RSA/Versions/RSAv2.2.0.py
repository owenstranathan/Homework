...
def main(argv):
    #startung up
    print "#########################STARTINGUP###########################"
    print "######### THIS IS RSA ENCRYPTION BY OWEN STRANATHAN ##########"
    print "\n"
    args = sys.argv
    public, private = keyGen(40)
    print "These are some public and private keys "
    print "Public"
    print public
    print "Private" 
    print private, "\n"
    print "Do not include the 'L'!"
    print "that is just there so python knows that it is a Long Int\n"
